...
LINE_INTENSITY_WHITE_THRESHOLD = 0.9
LINE_INTENSITY_BLACK_THRESHOLD = 0.75
TURN_TIME_PER_DEGREE = 0.011


# Parameters for the line following
LINE_FOLLOWING_BASE_SPEED = 60
LINE_FOLLOWING_PID_KP = 45.0
LINE_FOLLOWING_PID_KI = 0.0
LINE_FOLLOWING_PID_KD = 0.0
LINE_FOLLOWING_TURN_SPEED_GAIN = 0.5
LINE_FOLLOWING_SHARP_TURN_SPEED = 60  # TODO: Fix
LINE_FOLLOWING_SHARP_TURN_SPEED_BACK = -20  # TODO: Fix
