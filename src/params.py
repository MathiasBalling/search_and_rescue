...
LINE_FOLLOWING_BASE_SPEED = 0.15  # m/s
LINE_FOLLOWING_PID_KP = 0.08
LINE_FOLLOWING_PID_KI = 0.0
LINE_FOLLOWING_PID_KD = 0.01
LINE_FOLLOWING_TURN_SPEED_GAIN = 0.5
LINE_FOLLOWING_SHARP_TURN_SPEED = 0.1  # m/s
LINE_END_THRESHOLD = 1.0  # s
LINE_GAP_THRESHOLD = 0.4  # s
